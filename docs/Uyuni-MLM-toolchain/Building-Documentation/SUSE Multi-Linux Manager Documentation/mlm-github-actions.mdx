---
id: mlm-github-actions
title: GitHub Actions updates for SUSE Multi-Linux Manager releases
sidebar_label: GitHub Actions updates
description: Annual workflow update procedures for GitHub Actions when new SUSE Multi-Linux Manager major releases are created, including branch configuration and maintenance update patterns.
authors: [Joseph Cayouette]
tags: [github-actions, mlm, suse-multi-linux-manager, ci-cd, workflow-updates, release-management, automation]
---
...
5. Add comment indicating SUSE Multi-Linux Manager documentation only
